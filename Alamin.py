...
from concurrent.futures import ThreadPoolExecutor as CYBERCYBER
from string import * 
...
██   ██  ██ ███████ 
                    ...
                    1m
\033[1;37m------------------------------------------------
\033[1;37m Owner   :     alamin & tanvir 
\033[1;37m Facebook:     ALAMIN TERMUX HELP ZONE
\033[1;37m Github  :     CYBER-BD71
\033[1;37m Version :     V.14.0
\033[1;37m Tool Type :   PREMIUM
\033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with CYBERCYBER(max_workers=30) as CYBERworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
...
def cutter():
    ...
    print(" ")
    CYBER = input('Saving Put File Name :')
    os.system('touch ' +CYBER)
    os.system('sort -r '+CYBER+' | uniq > '+CYBER)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + CYBER )
    print(47*'-')
    print("File Saved To :" + CYBER )
    print(47*'-')
